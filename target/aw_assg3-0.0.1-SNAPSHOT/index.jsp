...
<body>
	...
	<div class="container">
  		...
  		<div class="panel panel-default">
			...
			<br>When a query is issued it is processed through the same analyzer that was used to build the index and then used to look up the matching term(s) in the index. That provides a list of documents that match the query.
			</h4>
		</div>
  		</div>
	</div>
